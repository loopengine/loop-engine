...
- Updated dependencies []:
  - @loop-engine/observability@1.0.0-rc.1
  - @loop-engine/registry-client@1.0.0-rc.1
...
- Updated dependencies []:
  ...
  - @loop-engine/guards@1.0.0-rc.0
  - @loop-engine/loop-definition@1.0.0-rc.0
  - @loop-engine/events@1.0.0-rc.0
  - @loop-engine/signals@1.0.0-rc.0
  - @loop-engine/observability@1.0.0-rc.0
  - @loop-engine/registry-client@1.0.0-rc.0
  - @loop-engine/adapter-memory@1.0.0-rc.0

## 0.2.0

### Minor Changes

- Add `LoopBuilder` (`packages/dsl/src/builder.ts`) for fluent `LoopDefinition` authoring, with `validateLoopDefinition` on build. Re-export from `@loop-engine/sdk`. Includes publish tarball validation and CI checks.

### Patch Changes

- Updated dependencies []:
  - @loop-engine/dsl@0.2.0
